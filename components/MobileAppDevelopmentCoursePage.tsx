...
import { ArrowRight, Smartphone, Layers, CheckCircle2, Award, Briefcase, Tablet, Globe, Code } from 'lucide-react';

const MobileAppDevelopmentCoursePage: React.FC = () => {
    return (
                    ...
                    <div className="container mx-auto max-w-7xl">
                        <div className="text-center space-y-8 max-w-4xl mx-auto">
                            ...
                            <h1 className="text-6xl md:text-8xl font-extrabold text-app-slate tracking-tighter leading-[1.05]">
                                Mobile App <span className="text-tech-blue">Development</span>
                            </h1>
                            <p className="text-slate-600 text-lg leading-relaxed font-medium max-w-2xl mx-auto">
                                Master the art of building powerful, user-friendly mobile applications for iOS and Android platforms with our comprehensive curriculum.
                            </p>
                        ...
                        <div className="flex flex-col lg:flex-row items-center gap-16">
                            <div className="flex-1 space-y-8">
                                ...
                                <h2 className="text-4xl md:text-5xl font-extrabold text-app-slate tracking-tighter leading-tight">
                                    Build for <span className="text-tech-blue">Every Device</span>
                                </h2>
                                <p className="text-slate-600 text-lg leading-relaxed font-medium">
                                    Our comprehensive curriculum covers everything from native development to cross-platform frameworks, ensuring you're ready for the dynamic mobile app market.
                                </p>
                            </div>
                            <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-6">
                                {[
                                    { icon: Smartphone, text: 'Android (Kotlin)' },
                                    { icon: Tablet, text: 'iOS (Swift)' },
                                    { icon: Layers, text: 'Cross-Platform' },
                                    { icon: Globe, text: 'App Store Deploy' }
                                ].map((item, idx) => (
                            ...
                            {[
                                {
                                    ...
                                    level: "Intermediate",
                                    desc: "Build high-performance cross-platform applications using JavaScript and React.",
                                    topics: ["React Native", "Expo", "Redux", "React Navigation"],
                                    tools: "VS Code, Android Studio / Xcode, React Native CLI"
                                },
                                {
                                    title: "iOS Development with Swift",
                                    level: "Intermediate",
                                    desc: "Create elegant and robust applications specifically for the Apple ecosystem.",
                                    topics: ["Swift Fundamentals", "UIKit & SwiftUI", "Core Data", "TestFlight"],
                                    tools: "Xcode, Swift, CocoaPods"
                                },
                                {
                                    title: "Android Development",
                                    level: "Intermediate",
                                    desc: "Build feature-rich Android apps using the latest development standards and tools.",
                                    topics: ["Kotlin", "Jetpack Compose", "Room Database", "Firebase"],
                                    tools: "Android Studio, Kotlin, Gradle"
                                }
                            ].map((module, index) => (
                ...
                <section className="section-spacing border-t border-slate-200 bg-white/40 backdrop-blur-sm">
                    <div className="container mx-auto px-6 max-w-7xl">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                            {[
                                { title: "Cross-Platform Expertise", desc: "Learn to develop for multiple platforms." },
                                { title: "App Portfolio", desc: "Build complete apps to show employers." },
                                { title: "Modern Practices", desc: "Master latest tools and frameworks." },
                                { title: "Publishing Experience", desc: "Learn the entire process to app stores." }
                            ].map((benefit, i) => (
                            ...
                            <div className="relative z-10 text-center space-y-8">
                                ...
                                <div className="flex flex-wrap justify-center gap-4">
                                    {[
                                        ...
                                        "React Native Developer", "Mobile Solutions Architect", "Mobile UI/UX Developer"
                                    ].map((role, i) => (
                        ...
                        <div className="relative rounded-3xl overflow-hidden glass-panel py-16 px-8 md:px-16 text-center border-slate-200 group">
                            ...
                            <div className="relative z-10 max-w-2xl mx-auto space-y-8">
                                <h2 className="text-4xl md:text-5xl font-extrabold text-app-slate tracking-tighter leading-none">
                                    Ready to <span className="text-tech-blue">Build Apps?</span>
                                </h2>
                                <p className="text-base text-slate-500 font-medium leading-relaxed">
                                    Join our next cohort and transform your career with in-demand mobile development skills.
                                </p>
