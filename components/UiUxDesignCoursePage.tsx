...
import { ArrowRight, CheckCircle2, Award, Users, Briefcase, Palette, MousePointer2, Smartphone } from 'lucide-react';
                    ...
                    <div className="container mx-auto max-w-7xl">
                        <div className="text-center space-y-8 max-w-4xl mx-auto">
                            ...
                            <h1 className="text-6xl md:text-8xl font-extrabold text-app-slate tracking-tighter leading-[1.05]">
                                UI/UX <span className="text-tech-blue">Design</span>
                            </h1>
                            <p className="text-slate-600 text-lg leading-relaxed font-medium max-w-2xl mx-auto">
                                Master the art of creating intuitive, engaging, and user-centered digital experiences with our comprehensive UI/UX design courses.
                            </p>
                        ...
                        <div className="flex flex-col lg:flex-row items-center gap-16">
                            <div className="flex-1 space-y-8">
                                ...
                                <h2 className="text-4xl md:text-5xl font-extrabold text-app-slate tracking-tighter leading-tight">
                                    Design Your <span className="text-tech-blue">Future</span>
                                </h2>
                                <p className="text-slate-600 text-lg leading-relaxed font-medium">
                                    Our UI/UX Design Training is crafted for beginners and aspiring designers who want to build a rewarding career without needing to write complex code. We focus on practical, industry-relevant skills that top employers value.
                                </p>
                            </div>
                            <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-6">
                                {[
                                    { icon: Palette, text: 'Visual Design Mastery' },
                                    { icon: Users, text: 'User Research' },
                                    { icon: MousePointer2, text: 'Interactive Prototyping' },
                            ...
                            {[
                                {
                                    ...
                                    desc: "Start your journey into UI Design with essential principles and hands-on practice. Learn how to design clean, functional interfaces.",
                                    learn: ["Visual design basics", "Typography & Layout", "Color theory"]
                                },
                                {
                                    title: "UX Design Principles",
                                    desc: "Enhance your skillset with a focus on UX Design — learn how to research users, validate your ideas, and create seamless user flows.",
                                    learn: ["User research methodologies", "Personas & Journey mapping", "Usability testing"]
                                },
                                {
                                    title: "Product Design Principles",
                                    desc: "Specialize in Product Design by creating polished, mobile-first digital products with animation and responsiveness.",
                                    learn: ["Mobile-specific UI patterns", "Micro-interactions", "Responsive layouts"]
                                }
                            ].map((module, index) => (
                                <div key={index} className="glass-panel rounded-[2.5rem] p-10 border-slate-200 hover:shadow-2xl transition-all duration-500 group relative overflow-hidden">
                                    ...
                                    <div className="relative z-10 space-y-6">
                                        ...
                                        <div className="pt-6 border-t border-slate-100">
                                            <h4 className="text-xs font-black uppercase text-tech-blue tracking-widest mb-4">What you'll learn</h4>
                    ...
                    <div className="container mx-auto px-6 max-w-7xl">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                            {[
                                ...
                                { title: "Career Support", desc: "Job placement assistance and interview prep." }
                            ].map((benefit, i) => (
                        ...
                        <div className="relative rounded-3xl overflow-hidden glass-panel py-16 px-8 md:px-16 text-center border-slate-200 group">
                            ...
                            <div className="relative z-10 max-w-2xl mx-auto space-y-8">
                                <h2 className="text-4xl md:text-5xl font-extrabold text-app-slate tracking-tighter leading-none">
                                    Ready to Start Your <span className="text-tech-blue">Tech Journey?</span>
                                </h2>
                                <p className="text-base text-slate-500 font-medium leading-relaxed">
                                    Join our next cohort and transform your career with in-demand design skills.
                                </p>
