...
import { ArrowRight, Code, Database, Brain, Globe, TrendingUp, Zap, Server, Terminal } from 'lucide-react';
                    ...
                    <div className="container mx-auto max-w-7xl">
                        <div className="text-center space-y-8 max-w-4xl mx-auto">
                            ...
                            <h1 className="text-6xl md:text-8xl font-extrabold text-app-slate tracking-tighter leading-[1.05]">
                                Python <span className="text-tech-blue">Programming</span>
                            </h1>
                            <p className="text-slate-600 text-lg leading-relaxed font-medium max-w-2xl mx-auto">
                                Master Python, the world's most versatile and popular programming language. From basic logic to data science and web development with Django.
                            </p>
                        ...
                        <div className="flex flex-col lg:flex-row items-center gap-16">
                            <div className="flex-1 space-y-8">
                                ...
                                <h2 className="text-4xl md:text-5xl font-extrabold text-app-slate tracking-tighter leading-tight">
                                    Simplicity Meets <span className="text-tech-blue">Power</span>
                                </h2>
                                <p className="text-slate-600 text-lg leading-relaxed font-medium">
                                    Python is known for its simplicity and readability, making it the perfect language for beginners and experts alike. It powers everything from simple scripts to complex AI models and large-scale web applications.
                                </p>
                            </div>
                            <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-6">
                                {[
                                    { icon: Code, text: 'Clean Syntax' },
                                    { icon: Brain, text: 'AI & Data Science' },
                            ...
                            {[
                                {
                                    ...
                                    desc: "Build a solid foundation in core programming logic and Python-specific idioms.",
                                    topics: ["Syntax & Data Types", "Control Structures", "Functions & Modules", "Error Handling"],
                                    icon: Terminal
                                },
                                {
                                    title: "Python for Data Science",
                                    desc: "Learn how to analyze large datasets, perform statistical analysis, and create stunning visualizations.",
                                    topics: ["NumPy", "Pandas", "Matplotlib", "Seaborn"],
                                    icon: TrendingUp
                                },
                                {
                                    title: "Django Web Development",
                                    desc: "Build robust and scalable web applications using the Django framework.",
                                    topics: ["MVT Architecture", "Database Integration", "REST API Development", "Deployment"],
                                    icon: Globe
                                }
                            ].map((module, index) => (
                                <div key={index} className="glass-panel rounded-[2.5rem] p-10 border-slate-200 hover:shadow-2xl transition-all duration-500 group relative overflow-hidden flex flex-col">
                                    ...
                                    <div className="relative z-10 space-y-6 flex-grow">
                                        ...
                                        <div className="space-y-4 pt-4 border-t border-slate-100">
                                            <h4 className="text-xs font-black uppercase text-tech-blue tracking-widest mb-3">Key Topics</h4>
                ...
                <section className="section-spacing border-t border-slate-200 bg-white/40 backdrop-blur-sm">
                    <div className="container mx-auto px-6 max-w-7xl">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                            {[
                                { title: "Versatile Skills", desc: "Use Python for Web, AI, Data & more." },
                                { title: "High Demand", desc: "Companies like Google & NASA use Python." },
                                { title: "Rapid Development", desc: "Write less code to achieve more." },
                                { title: "Career Growth", desc: "Access high-paying jobs in tech." }
                            ].map((benefit, i) => (
                        ...
                        <div className="glass-panel p-12 rounded-[3rem] border-slate-200 relative overflow-hidden">
                            ...
                            <div className="relative z-10 text-center space-y-8">
                                ...
                                <p className="text-slate-600 text-lg font-medium">
                                    This course prepares you for diverse roles such as:
                                </p>
                                <div className="flex flex-wrap justify-center gap-4">
                                    {[
                                        "Python Developer", "Data Scientist", "Backend Engineer",
                                        "AI/ML Engineer", "Automation Engineer", "Web Developer", "Data Analyst"
                                    ].map((role, i) => (
                        ...
                        <div className="relative rounded-3xl overflow-hidden glass-panel py-16 px-8 md:px-16 text-center border-slate-200 group">
                            ...
                            <div className="relative z-10 max-w-2xl mx-auto space-y-8">
                                <h2 className="text-4xl md:text-5xl font-extrabold text-app-slate tracking-tighter leading-none">
                                    Ready to <span className="text-tech-blue">Start Coding?</span>
                                </h2>
                                <p className="text-base text-slate-500 font-medium leading-relaxed">
                                    Join our next cohort and transform your career with in-demand Python skills.
                                </p>
